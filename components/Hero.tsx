...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden bg-gradient-to-br from-[#FFFAF5] via-[#fff5eb] to-[#ffe8d6] py-12 lg:py-16">
      ...
      <motion.div style={{ y, opacity }} className="container relative z-10 py-8 lg:py-12">
